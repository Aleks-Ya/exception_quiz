...
/**
 * Набор всех операторов Java.
 * todo Выделить набор операторов для OCA и для Programmer.
 */
class OperatorData {
    ...
    static {
        ...
        OPERATORS.add(new Operator("~", "bitwise NOT", 2, RIGHT));
        ...
        OPERATORS.add(new Operator("<<", "signed bit shift left", 5, LEFT));
        OPERATORS.add(new Operator(">>", "signed bit shift right", 5, LEFT));
        OPERATORS.add(new Operator(">>>", "unsigned bit shift right", 5, LEFT));
        ...
        OPERATORS.add(new Operator("&", "bitwise AND", 8, LEFT));
        OPERATORS.add(new Operator("&", "boolean (logical) AND", 8, LEFT));

        OPERATORS.add(new Operator("^", "bitwise XOR", 9, LEFT));
